...
class OrderDialogBloc extends Bloc<OrderDialogEvent, OrderDialogState> {
  ...
  void _onOpenBuyOrder(
    OpenBuyOrderEvent event,
    Emitter<OrderDialogState> emit,
  ) {
    emit(
      OrderDialogState(
