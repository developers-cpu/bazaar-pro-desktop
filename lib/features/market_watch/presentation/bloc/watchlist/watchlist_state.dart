...
class WatchlistLoaded extends WatchlistState {
  ...
  const WatchlistLoaded({required this.watchlists, this.selectedIndex = -1});
  WatchlistLoaded copyWith({List<String>? watchlists, int? selectedIndex}) {
...
class WatchlistSuccess extends WatchlistState {
  ...
  const WatchlistSuccess({required this.message, required this.previousState});
  @override
