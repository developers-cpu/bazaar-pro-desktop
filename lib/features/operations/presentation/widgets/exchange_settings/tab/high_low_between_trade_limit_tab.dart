...
class HighLowBetweenTradeLimitTab extends StatelessWidget {
  ...
  const HighLowBetweenTradeLimitTab({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            _radioOption('Yes', tradeLimitYes, () => onTradeLimitChanged(true)),
            SizedBox(width: 10.w),
            _radioOption(
              'No',
              !tradeLimitYes,
              () => onTradeLimitChanged(false),
            ),
          ],
        ),
