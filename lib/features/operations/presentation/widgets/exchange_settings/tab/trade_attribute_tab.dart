...
class TradeAttributeTab extends StatelessWidget {
        ...
        if (isDetailView) ...[
          Row(
            children: [
              ...
              SizedBox(width: 12.w),
              Text(
                'Trade Settings  (${selectedExchange!})',
        ...
        Row(
          children: [
            _radioOption(
              'Full',
              attributeType == 'Full',
              () => onAttributeTypeChanged('Full'),
            ),
            SizedBox(width: 10.w),
            _radioOption(
              'Close',
              attributeType == 'Close',
              () => onAttributeTypeChanged('Close'),
            ),
            SizedBox(width: 10.w),
            _radioOption(
              'Block',
              attributeType == 'Block',
              () => onAttributeTypeChanged('Block'),
            ),
          ],
        ),
  ...
  Widget _searchAndRecord(int recordCount) => Row(
    children: [
      CustomInputField(
        hintText: 'Search',
