...
class SettlementProgressIndicatorDialog extends StatelessWidget {
  const SettlementProgressIndicatorDialog({super.key});
  ...
  Widget build(BuildContext context) {
    return CommonDialog(
      ...
      content: BlocBuilder<SettlementProgressBloc, SettlementProgressState>(
