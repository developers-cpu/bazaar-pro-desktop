...
class BrokerageDetailView extends StatefulWidget {
  final bool isDarkMode;
  const BrokerageDetailView({super.key, this.isDarkMode = false});
  @override
  State<BrokerageDetailView> createState() => _BrokerageDetailViewState();
}

class _BrokerageDetailViewState extends State<BrokerageDetailView> {
  DateTimeRange? _selectedDateRange;

  @override
  Widget build(BuildContext context) {
    final columns = [
      const ViewTableColumn(id: 'exchange', label: 'EXCHANGE', width: 140),
      const ViewTableColumn(
        id: 'oldValue',
        label: 'OLD TUNOVER/LOT WISE',
        width: 200,
        isNumeric: true,
      ),
      const ViewTableColumn(
        id: 'newValue',
        label: 'NEW TUNOVER/LOT WISE',
        width: 200,
        isNumeric: true,
      ),
