...
class ServerDetailDialog extends StatefulWidget {
  ...
  const ServerDetailDialog({super.key, required this.activity});
  ...
  static void show(BuildContext context, BackOfficeActivityReport activity) {
    CommonDialog.show(
      ...
      height: 650.h,
      scrollable: false,
      content: ServerDetailDialog(activity: activity),
      showButtons: false,
    );
  }
...
class _ServerDetailDialogState extends State<ServerDetailDialog> {
  ...
  List<Map<String, dynamic>> _getMockData() {
    ...
    return List.generate(
      ...
      (i) => {
        'oldServerName': 'Server ${6 - i}',
        'newServerName': 'Server ${7 - i}',
