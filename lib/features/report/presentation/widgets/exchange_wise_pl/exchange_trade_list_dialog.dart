...
import 'package:bazarpro/features/report/presentation/widgets/exchange_wise_pl/trade_list_filter_bar.dart';
...
class ExchangeTradeListDialog extends StatelessWidget {
  ...
  static void show(BuildContext context, {String? symbol, String? exchange}) {
    CommonDialog.show(
      ...
      width: 1200.w,
      height: 700.h,
      content: ExchangeTradeListDialog(symbol: symbol, exchange: exchange),
      showButtons: false,
    );
  }
