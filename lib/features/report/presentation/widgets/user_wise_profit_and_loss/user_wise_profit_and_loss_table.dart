...
class UserWiseProfitAndLossReportTable extends StatelessWidget {
  ...
  List<ViewTableColumn> _getColumns() {
    return const [
      ...
      ViewTableColumn(id: 'mtm', label: 'MTM', width: 100),
      ViewTableColumn(id: 'releasedPL', label: 'REL.PL', width: 120),
      ViewTableColumn(id: 'brokerage', label: 'BRK', width: 80),
      ViewTableColumn(id: 'netPL', label: 'NET P/L', width: 120),
      ViewTableColumn(id: 'credit', label: 'CRD', width: 120),
      ViewTableColumn(id: 'equity', label: 'EQTY', width: 120),
      ViewTableColumn(id: 'margin', label: 'MARGIN', width: 120),
      ViewTableColumn(id: 'usedMargin', label: 'USED MARGIN', width: 120),
      ViewTableColumn(id: 'freeMargin', label: 'FREE MARGIN', width: 120),
      ViewTableColumn(id: 'standingVolume', label: 'STANDING VOL', width: 120),
      ViewTableColumn(
