...
class PendingOrderModel extends PendingOrder {
  ...
  factory PendingOrderModel.fromJson(Map<String, dynamic> json) {
    return PendingOrderModel(
      ...
      qty: _parseDouble(json['qty']).abs(),
      lot: _parseDouble(json['lot']).abs(),
      triggerPrice: _parseDouble(
        json['trigger_price'] ?? json['t_price'],
      ).abs(),
      ...
      cmp: _parseDouble(json['cmp']).abs(),
      rPrice: _parseDouble(json['r_price'] ?? json['rPrice']).abs(),
