...
class PendingToSuccessDialog extends StatelessWidget {
  final PendingOrder order;
  final bool isDarkMode;

  const PendingToSuccessDialog({
    Key? key,
    required this.order,
  ...
  static void show({
    ...
    showDialog(
      ...
      builder: (_) =>
          PendingToSuccessDialog(order: order, isDarkMode: isDarkMode),
    );
  }
                    ...
                    onPressed: () {
                      ...
                      Future.delayed(Duration.zero, () {
                        SuccessDialog.show(
                          ...
                          title: 'Successful !',
                          subtitle:
                              'Pending to Success Order Successfully Done',
                        );
                      });
                    },
                  ),
